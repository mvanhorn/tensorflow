...
TEST(ComputePeakMemoryTest, MultipleBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 60);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 60);
...
TEST(ComputePeakMemoryTest, SharedBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 10);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 10);
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 10);
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 20);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 20);
...
TEST(ComputePeakMemoryTest, SharedChain) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 310);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 310);
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 4000);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 4000);
...
TEST(ComputePeakMemoryTest, SharingAllocatesBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 200);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 200);
...
TEST(ComputePeakMemoryTest, EmptyProto) {
  HloModuleProto hlo;
  BufferAssignmentProto proto;
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 0);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 0);
...
TEST(ComputePeakMemoryTest, MultipleAssignments) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 333);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 333);
...
TEST(ComputePeakMemoryTest, ShareParameter) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 1024);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded, 1024);
...
TEST(ComputePeakMemoryTest, ParamBufferAndAllocationBuffer) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 123 + 321);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded,
            123 + 321);
...
TEST(ComputePeakMemoryTest, LargeResult) {
  ...
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().padded, 1LL << 33);
  EXPECT_EQ(ComputePeakMemorySizes(proto, hlo).ValueOrDie().unpadded,
            1LL << 33);
