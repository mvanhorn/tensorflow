...
TEST(SPMDPartitionerUtilTest,
  ...
  EXPECT_EQ(v3_group_list->ToString(), "mesh['a'=4,'b'=2,'c'=3] {'b','a'}");
...
TEST(SPMDPartitionerUtilTest,
  ...
  EXPECT_EQ(v3_group_list->num_devices_per_group(), 8);
  EXPECT_EQ(v3_group_list->ToString(), "mesh['a'=8,'b'=4] {'b','a':(4)2}");
  ...
  EXPECT_EQ(v3_group_list->num_replica_groups(), 4);
  EXPECT_EQ(v3_group_list->num_devices_per_group(), 8);
  EXPECT_EQ(v3_group_list->ToString(), "mesh['a'=8,'b'=4] {'a':(2)4,'b':(2)2}");
}
